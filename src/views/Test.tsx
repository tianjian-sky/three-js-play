...
import { Scene, AxesHelper, PerspectiveCamera, WebGLRenderer, BoxGeometry, SphereGeometry, MeshBasicMaterial, MeshStandardMaterial, Mesh, Group, AmbientLight, HemisphereLight, ArrowHelper } from 'three'
...
export default class TestComponent extends Vue {
    ...
    loadModel(url: string): Promise<any> {
        const p = new Promise((resolve, reject) => {
            ...
            loader.load(url, (gltf: GLTF) => {
                ...
                if (url.includes('nongkeyuan') || url.includes('jiaoxuelou')) {
    ...
    mounted() {
        ...
        this.loadModel('/models/gltf/jiaoxuelou/main.gltf').then(this.addModelToScene)
